"""
Script đánh giá với Hybrid Pipeline
So sánh các chiến lược: cost-optimized, quality-optimized, hybrid
"""
...
def evaluate_with_strategy(
    ...
    """
    Đánh giá với một chiến lược cụ thể
    ...
    print(f"  Fallback triggered: {stats['fallback_triggered']} ({stats['fallback_rate']})")
...
def compare_strategies(
    ...
    print(f"{'Strategy':<20} {'Accuracy':<12} {'Small%':<10} {'Large%':<10} {'Fallback%':<12} {'Avg Time':<10}")
    print("-" * 80)
    ...
    for strategy in strategies:
        ...
        print(f"{strategy:<20} {accuracy:<12} {small_pct:<10} {large_pct:<10} {fallback_rate:<12} {avg_time:<10}")
